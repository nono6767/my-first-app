...
// 気になる部位・ケガ歴・既往歴（該当する項目を選ぶと、避けたい動作と代わりにできる具体的なエクササイズを表示する）。
// note があれば、医師・理学療法士への確認を優先すべき旨を特に強調して表示する。
const CAUTION_AREAS = [
  {
    id: "herniated-disc",
    label: "椎間板ヘルニア",
    avoid: [
      "深い前屈（特に体幹を丸めながら勢いよく動く動作。椎間板内圧を高めやすい）",
      "早い反復での体幹屈曲（ロールアップ・ロールオーバーなど）",
      "重い負荷をかけた状態での前屈・回旋の複合動作",
    ],
    exercises: [
      { name: "ペルビックカール（浅い範囲で）", note: "体幹を安定させたまま骨盤の動きを引き出し、椎間板への圧迫を避ける" },
      { name: "プランク（膝つきなど負荷を調整して）", note: "脊柱をニュートラルに保ったまま体幹の安定性を高める" },
      { name: "ニーストレッチ（腰を丸めすぎない範囲で）", note: "股関節を使い、腰椎への負担を分散する" },
    ],
  },
  {
    ...
    label: "脊椎すべり症",
    avoid: [
      "腰を反らす動作（伸展）、とりわけ強い反り（すべりを助長しやすい）",
      "体幹を強く回旋させながらの伸展複合動作",
      "重い負荷を支えた状態でのブリッジ・バックエクステンション",
    ],
    exercises: [
      { name: "ペルビックカール（反らしすぎない範囲で）", note: "腰椎を安定させながら骨盤の動きを学ぶ" },
      { name: "アブドミナルカール", note: "深層腹筋を使い、脊柱の分節を支える安定性を養う" },
      { name: "ニーストレッチ", note: "股関節主導の動きを学び、腰椎の過伸展を防ぐ" },
    ],
  },
  {
    id: "scoliosis",
    label: "脊柱側弯症",
    avoid: [
      "左右非対称を強調する一方向だけの反復動作（カーブを助長する可能性）",
      "体幹を強く圧迫するような重い負荷の軸圧動作",
      "呼吸を止めた状態での強い体幹の力み",
    ],
    exercises: [
      { name: "サイドベンドストレッチ（両方向、硬い側を重点的に）", note: "左右の柔軟性のバランスを整える" },
      { name: "スパインツイスト（左右均等に）", note: "回旋の可動性を左右均等に保つ" },
      { name: "横隔膜呼吸を使ったブリージング", note: "凹んでいる側の肋骨・肺の使い方を意識づける" },
    ],
  },
  {
    id: "osteoarthritis",
    label: "変形性関節症",
    avoid: [
      "関節に強い衝撃がかかる動作（ジャンプなど）",
      "可動域の終わりまで無理に押し込む動作",
      "同じ姿勢を長時間保持する静的な負荷",
    ],
    exercises: [
      { name: "レッグサークル（無理のない可動域で）", note: "関節に負担をかけずに関節液の循環と可動性を保つ" },
      { name: "サイドキック（振り幅を小さく）", note: "関節を安定させる周囲の筋力を無理なく養う" },
      { name: "ペルビックカール", note: "体重を関節に集中させずに股関節・体幹を使う" },
    ],
  },
  {
    id: "acute-low-back",
    label: "ギックリ腰",
    note: "痛みが強い急性期は運動を控え、医師の診断を優先してください。以下は痛みが落ち着いてから、無理のない範囲での目安です。",
    avoid: [
      "前屈・回旋動作全般（痛みが強い間は特に避ける）",
      "勢いをつけた動き（急な立ち上がり・振り向き動作）",
      "長時間の同一姿勢保持（特に前かがみ姿勢）",
    ],
    exercises: [
      { name: "ペルビックティルト（ごく小さな範囲で）", note: "痛みのない範囲で腰まわりの血流を促す" },
      { name: "ニースウェイ（膝を軽く左右に倒す）", note: "腰椎を大きく動かさずに股関節まわりをゆるめる" },
      { name: "横隔膜呼吸を使ったブリージング", note: "体幹の緊張をゆるめ、リラックスを促す" },
    ],
  },
  {
    id: "meniscus-injury",
    label: "半月板損傷",
    avoid: [
      "膝を深く曲げる動作（深いプリエ、しゃがみ込み）",
      "膝をひねる動き（足を固定したまま体幹だけ回旋する動作）",
      "片脚への強い荷重・衝撃（ジャンプ、片脚着地）",
    ],
    exercises: [
      { name: "レッグサークル（浅い可動域で）", note: "膝を安定させながら股関節の動きを引き出す" },
      { name: "サイドキック（膝を伸ばした状態で）", note: "膝関節を動かさずに股関節周囲の筋力を養う" },
      { name: "シングルレッグブリッジ（膝の角度を浅めに）", note: "殿筋・ハムストリングスを使い、膝を保護する" },
    ],
  },
  {
    id: "joint-replacement",
    label: "人工関節置換術",
    note: "医師・理学療法士から許可された可動域・負荷の範囲を必ず確認してから行ってください。",
    avoid: [
      "指示された可動域を超える動作（股関節の場合は特に、深い屈曲・内旋・内転の組み合わせ）",
      "関節に強い衝撃・ひねりが加わる動作",
      "許可前の負荷をかけた運動",
    ],
    exercises: [
      { name: "レッグサークル（許可された可動域内で）", note: "手術部位に配慮しながら関節の動きを保つ" },
      { name: "ペルビックカール（負荷を軽く）", note: "体幹・殿筋を使い、関節への負担を減らす" },
      { name: "アームサークルなど上半身のエクササイズ", note: "下肢に荷重をかけず、全身の血流とコンディションを保つ" },
    ],
  },
  {
    id: "acl-reconstruction",
    label: "膝前十字靭帯再建後",
    note: "リハビリの進行段階（術後何週目か）によって許可される動きが大きく異なります。理学療法士の指示に従ってください。",
    avoid: [
      "リハビリの段階を超えた深い膝の屈曲・伸展",
      "膝に捻りが加わる動作（切り返し、ひねりを伴う動き）",
      "片脚での急な着地・ジャンプ動作",
    ],
    exercises: [
      { name: "レッグサークル（許可された可動域で）", note: "関節の可動性を保ちながら靭帯への負担を避ける" },
      { name: "サイドキック（膝を伸ばした状態で）", note: "膝関節を動かさずに股関節・殿筋を使う" },
      { name: "大腿四頭筋のアイソメトリックエクササイズ（膝を伸ばした状態で）", note: "靭帯に負担をかけずに膝まわりの筋力を保つ" },
    ],
  },
  {
    id: "general-pain",
    ...
    exercises: [
      { name: "チンタック", note: "首まわりの緊張をゆるめ、頭の位置を整える" },
      { name: "チェストオープナー", note: "硬くなりやすい胸・肩まわりをゆるめる" },
      { name: "ペルビックカール", note: "体幹を使い、腰・背中への負担を減らしながら動く感覚を養う" },
    ],
  },
  {
    id: "breast-cancer-survivor",
    label: "乳がんサバイバー",
    note: "リンパ浮腫のリスクがある場合、患側の腕に負荷をかける動作は医師の許可を確認してから行ってください。",
    avoid: [
      "患側（手術・リンパ節郭清を行った側）の腕に強い負荷・締め付けがかかる動作",
      "患側の腕を勢いよく大きく振る・引っ張る動作",
      "強い胸郭の圧迫・過度な伸展動作",
    ],
    exercises: [
      { name: "レッグサークル", note: "上半身に負担をかけずに全身の血流を促す" },
      { name: "チェストオープナー（無理のない範囲で）", note: "硬くなりやすい胸・肩まわりをやさしくゆるめる" },
      { name: "横隔膜呼吸を使ったブリージング", note: "呼吸筋を使い、リンパの流れと胸郭の動きをやさしく促す" },
    ],
  },
  {
    id: "osteoporosis",
    label: "骨粗鬆症",
    note: "椎体骨折のリスクがあるため、体幹を丸める動作と回旋を組み合わせた動きは特に注意してください。",
    avoid: [
      "体幹を強く丸める動作（特に前屈＋回旋の複合動作）",
      "勢いをつけた動き・強い衝撃を伴う動作",
      "深い前屈で体重を支えるような動作",
    ],
    exercises: [
      { name: "ペルビックカール（浅い範囲で）", note: "体幹を丸めすぎずに骨盤・殿筋を使う" },
      { name: "バックエクステンション（軽い範囲で）", note: "背筋を使い、丸まった姿勢を防ぐ伸展方向の強化" },
      { name: "サイドキック", note: "股関節まわりの筋力を安全に養う" },
    ],
  },
  {
    id: "maternity-postpartum",
    label: "マタニティ・産後ケア",
    note: "妊娠週数・産後の経過には個人差があります。医師の運動許可と合わせて確認してください。",
    avoid: [
      "仰向けで長時間行う動作（特に妊娠中期以降、仰臥位低血圧のリスク）",
      "強い腹圧をかける動作（強い腹筋の丸め込み、息を止めるいきみ動作）",
      "うつ伏せでの動作（お腹に圧がかかる姿勢）",
    ],
    exercises: [
      { name: "サイドキック（横向きで行う）", note: "仰向けを避けながら股関節・殿筋を安全に使う" },
      { name: "骨盤底筋を意識したエクササイズ", note: "産前産後で負担のかかる骨盤底の機能を養う" },
      { name: "横隔膜呼吸を使ったブリージング", note: "腹圧のコントロールと体幹の意識づけを行う" },
    ],
  },
];
