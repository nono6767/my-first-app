...
const POSTURE_ASSESSMENTS = [
  {
    ...
    exercises: [
      ...
      { name: "アームサークル（外旋方向）", note: "胸を開きながら肩甲骨まわりの筋肉を使い、巻き込んだ肩を整える" },
      {
        name: "シングルレッグストレッチ（頭を軽く起こす程度で）",
        note: "胸椎を過度に丸めないよう注意しながら、深層腹筋を活性化する",
      },
      { name: "スパインツイスト（座位）", note: "胸椎の回旋可動性を引き出しながら、体幹の安定を保つ" },
      {
        name: "ロングボックス（プリングストラップ I & II）",
        note: "硬くなった胸まわりを開きながら、菱形筋・僧帽筋中部で丸まった背中を整える",
        equipment: ["reformer"],
      },
      {
        name: "ストマック・マッサージ（ラウンド）",
        note: "腹筋・殿筋を使い、骨盤の前傾と反り腰を整える",
        equipment: ["reformer"],
      },
      {
        name: "ショートボックス（フラット）",
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "シェルストレッチ", note: "股関節を使い、骨盤をニュートラルに近づけながら背骨を優しく伸ばす" },
      {
        name: "スパインストレッチフォワード（浅い可動域で）",
        note: "背骨のカーブを取り戻す感覚を、無理のない範囲で養う",
      },
      { name: "レッグサークル", note: "骨盤を安定させたまま股関節の可動性を引き出す" },
      {
        name: "ニーストレッチ・シリーズ（フラット）",
        note: "硬くなりやすいハムストリングスをゆるめ、骨盤の動きを取り戻す",
        equipment: ["reformer"],
      },
      {
        name: "ロングストレッチ・シリーズ（エレファント）",
        note: "股関節を使い、骨盤を動かす感覚をつくる",
        equipment: ["reformer"],
      },
      {
        name: "ショートボックス（ラウンド）",
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "シングルレッグサークル", note: "骨盤を安定させたまま、腸腰筋・大腿直筋を働かせる" },
      { name: "オブリークカール", note: "腹斜筋群を使い、骨盤の位置を安定させる感覚を養う" },
      { name: "ハムストリングスストレッチ", note: "股関節が前に突き出すのを防ぐため、もも裏の柔軟性も整える" },
      {
        name: "フットワーク・シリーズ（ヒール）",
        note: "股関節が前に流れた骨盤の位置を、ニュートラルに戻す感覚を養う",
        equipment: ["reformer"],
      },
      {
        name: "レッグ・サークル",
        note: "腸腰筋を活性化し、股関節が前に突き出す姿勢を整える",
        equipment: ["reformer"],
      },
      {
        name: "ペルビックリフト",
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        name: "ハンドレッド",
        note: "頭を持ち上げた姿勢を保ちながら、深層の頸部屈筋を働かせる",
        equipment: ["reformer"],
      },
      {
        name: "ロングボックス（プリングストラップ I & II）",
        note: "僧帽筋下部を使いながら、頭〜背中のラインを整える",
        equipment: ["reformer"],
      },
      {
        name: "ショートボックス（ツリー・フロント）",
        note: "胸椎の伸展を引き出し、頭が前に出る姿勢を整える",
        equipment: ["reformer"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      {
        name: "ロングボックス（プリングストラップ I & II）",
        note: "菱形筋・僧帽筋中部を使い、肩を正しい位置に引き戻す",
        equipment: ["reformer"],
      },
      {
        name: "アーム・サークル（外旋方向を意識）",
        note: "硬くなった大胸筋・小胸筋をゆるめながら肩甲骨を正しく使う",
        equipment: ["reformer"],
      },
      {
        name: "ストマック・マッサージ（ハンズ・バック）",
        note: "胸を開きながら肩甲骨まわりの筋肉を使う",
        equipment: ["reformer"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      {
        name: "ストマック・マッサージ（ハンズ・バック）",
        note: "胸を開き、丸まった背中を伸ばす",
        equipment: ["reformer"],
      },
      {
        name: "ロングボックス（プリングストラップ I & II）",
        note: "正しい上体の起こし方を身につけ、猫背の癖を減らす",
        equipment: ["reformer"],
      },
      {
        name: "ショートボックス（フラット）",
        note: "背骨を一節ずつ動かす感覚を養い、姿勢を整える",
        equipment: ["reformer"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      {
        name: "ストマック・マッサージ（ラウンド）",
        note: "腹筋・殿筋を使い、前に傾いた骨盤を戻す",
        equipment: ["reformer"],
      },
      {
        name: "フットワーク・シリーズ（テンダン・ストレッチ）",
        note: "骨盤を前に引っ張る腸腰筋の硬さをゆるめる",
        equipment: ["reformer"],
      },
      { name: "ハンドレッド", note: "下部腹筋を使い、骨盤の傾きを安定させる", equipment: ["reformer"] },
    ],
  },
  {
    ...
    exercises: [
      ...
      {
        name: "ニーストレッチ・シリーズ（フラット）",
        note: "骨盤を後ろに引っ張るハムストリングスの硬さをゆるめる",
        equipment: ["reformer"],
      },
      { name: "レッグ・サークル", note: "弱くなりやすい腸腰筋を働かせる", equipment: ["reformer"] },
      { name: "ショートボックス（ラウンド）", note: "失われがちな腰のカーブを取り戻す", equipment: ["reformer"] },
    ],
  },
];
